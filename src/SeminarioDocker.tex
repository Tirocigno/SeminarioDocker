...
\subsection{Docker: le basi} % A subsection can be created just before a set of slides with a common theme to further break down your presentation into chunks
...
%Le modalità di utilizzo di docker sono talmente varie che molte compagnie utilizzano la piattaforma per scopi molto diversi
